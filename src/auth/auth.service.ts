...
export class AuthService {
        ...
        userToAttempt.checkPassword(
          ...
          async (err, isMatch) => {
            ...
            if (isMatch) {
              ...
              resolve(new UnauthorizedException('password is wrong'));
            }
          },
        );
      else resolve(new HttpException('Email is wrong', HttpStatus.NOT_FOUND));
    });
  }
  ...
  async validateUserByJwt(payload: JwtPayload) {
    ...
    if (user) {
      ...
      return new UnauthorizedException("User doesn't exist");
    }
  }
